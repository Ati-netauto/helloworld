...
Following section describes how each is element used for creating application in AWS  
...
If it is still not working please check if Terraform has installed Node.js and NPM successfully on the EC2 instance
